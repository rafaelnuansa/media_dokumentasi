...
<g>
	...
	<path style="fill:#808080;" d="M393.695,417.909l8.485-20.662l25.251,25.251c1.464,1.464,3.387,2.199,5.303,2.192
		c1.923,0,3.84-0.728,5.303-2.192l-83.142-83.142L393.695,417.909z"/>
                ...
                <div class="col-md-7 card-center">
                            ...
                            <div class="tab-content" id="top-tabContent">
                                <div class="tab-pane fade show active" id="top-profile" role="tabpanel" aria-labelledby="top-profile-tab">
                                 <?php if (session()->has('login')) : ?>
                                  ...
                                  <?php elseif (session()->has('username')) : ?>
                                  ...
                                  <?php endif; ?>
                                    <form class="form-horizontal auth-form" method="post" action="<?= base_url(); ?>/auth/valid-login">
                                        ...
                                        <div class="form-terms">
                                            <div class="form-check mesm-2">
                                                ...
                                                <!--<a href="#" class="btn btn-default forgot-pass">Lupa Password</a>-->
                                            </div>
                                        </div>
             ...
             <a href="<?= base_url(); ?>" class="btn btn-primary back-btn"><i data-feather="arrow-left"></i>Website PUSDOK</a>
        </div>
    </div>
</div>
